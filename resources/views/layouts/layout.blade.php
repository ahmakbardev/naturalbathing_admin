...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/styles/css/app.css?v=1.06') }}">
    <!-- Add cache-control headers for CSS and JavaScript files -->
    <link rel="preload" href="{{ asset('assets/styles/css/app.css?v=1.06') }}" as="style" crossorigin="anonymous" />
