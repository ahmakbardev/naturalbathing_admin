            ...
            <div class="md:flex">
                <div class="w-full p-3">
                    <div class="flex justify-between items-center">
                        <h2 class="text-gray-900 font-medium text-xl">Edit Map Section</h2>
                    </div>
                    <form action="{{ route('content.map-section.update', $mapSection->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mt-2">
