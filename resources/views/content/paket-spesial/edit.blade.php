                    ...
                    <form action="{{ route('content.paket-spesial.update', $paketSpesial->id) }}" method="POST"
                        ...
                        <div class="mt-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi"
                                class="w-full px-3 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-blue-500">{{ $paketSpesial->deskripsi }}</textarea>
                        </div>
                        <div class="mt-2">
